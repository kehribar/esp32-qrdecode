 ...
 */
IRAM_ATTR uint8_t *quirc_begin(struct quirc *q, int *w, int *h);
IRAM_ATTR void quirc_end(struct quirc *q);
...
IRAM_ATTR void quirc_extract(const struct quirc *q, int index,
		   struct quirc_code *code);

/* Decode a QR-code, returning the payload data. */
IRAM_ATTR quirc_decode_error_t quirc_decode(const struct quirc_code *code,
